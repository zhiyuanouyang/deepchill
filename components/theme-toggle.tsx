...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({ className = '' }) => {
  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-xl transition-all duration-300 cursor-pointer select-none group border ${
        isDark
