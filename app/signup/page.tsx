...
export const metadata: Metadata = {
  title: 'Sign Up | Deepchill Directory',
  description: 'Create an account on Deepchill to launch your products, gain backlinks, and reach makers.',
};
      ...
      <Suspense
        fallback={
          <div className="w-full max-w-md p-8 liquid-glass rounded-3xl border border-white/60 dark:border-white/10 shadow-2xl flex items-center justify-center min-h-[400px]">
            <div className="text-slate-400 text-sm">Loading sign up...</div>
          </div>
        }
      >
