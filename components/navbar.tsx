    ...
    <header className="sticky top-4 z-40 w-full max-w-7xl mx-auto px-4 sm:px-6 mb-8">
      <div className="liquid-glass rounded-2xl px-4 py-3 sm:px-6 flex items-center justify-between gap-4 transition-all">
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link
            href="/categories"
            className="text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 px-3 py-2 rounded-xl hover:bg-white/70 dark:hover:bg-slate-800/60 transition-colors"
          >
            Categories
          </Link>
        </nav>
